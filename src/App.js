      ...
      {visibleCount < sorted.length && (
        ...
        <section data-snay3i-tools-hub="1" style={{background:'#fff',border:'1.5px solid var(--border)',borderRadius:18,padding:'22px 20px',margin:'22px 0'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(210px,1fr))',gap:10}}>
            ...
            <a href="/outils/planificateur-budget-renovation" style={{padding:14,borderRadius:12,background:'var(--cream)',color:'var(--ink)',textDecoration:'none'}}><strong>💰 Budget rénovation</strong><span style={{display:'block',fontSize:12,color:'var(--muted)',marginTop:4}}>Lots, écarts et réserve.</span></a>
